...
#define ti_sysbios_smp_LoggerBuf_TimestampProxy___VERS 160
...
typedef xdc_Bool (*CT__ti_sysbios_smp_LoggerBuf_TimestampProxy_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_sysbios_smp_LoggerBuf_TimestampProxy_Module__startupDoneFxn ti_sysbios_smp_LoggerBuf_TimestampProxy_Module__startupDoneFxn__C;
...
/* Object__create__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__create__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__create__S")
__extern xdc_Ptr ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );

/* Object__delete__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__delete__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__delete__S")
__extern xdc_Void ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__destruct__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__destruct__S")
__extern xdc_Void ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__destruct__S( xdc_Ptr objp );
...
__extern xdc_Ptr ti_sysbios_smp_LoggerBuf_TimestampProxy_Proxy__delegate__S( void );
