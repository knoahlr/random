...
#define ti_sysbios_smp_LoggerBuf___VERS 160
...
__extern xdc_Int ti_sysbios_smp_LoggerBuf_Instance_init__E(ti_sysbios_smp_LoggerBuf_Object *, const ti_sysbios_smp_LoggerBuf_Params *, xdc_runtime_Error_Block *);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_Instance_finalize__E, "ti_sysbios_smp_LoggerBuf_Instance_finalize")
__extern void ti_sysbios_smp_LoggerBuf_Instance_finalize__E( ti_sysbios_smp_LoggerBuf_Object* , int );
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_Object__destruct__S, "ti_sysbios_smp_LoggerBuf_Object__destruct__S")
