...
#define ti_sysbios_family_arm_a9_Timer___VERS 160
...
/* deviceRegs */
#define ti_sysbios_family_arm_a9_Timer_deviceRegs ti_sysbios_family_arm_a9_Timer_deviceRegs
...
struct ti_sysbios_family_arm_a9_Timer_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_family_arm_a9_Timer_Handle);
    xdc_Void (*setNextTick)(ti_sysbios_family_arm_a9_Timer_Handle, xdc_UInt32);
    ...
    xdc_UInt32 (*getExpiredTicks)(ti_sysbios_family_arm_a9_Timer_Handle, xdc_UInt32);
    xdc_UInt32 (*getCurrentTick)(ti_sysbios_family_arm_a9_Timer_Handle, xdc_Bool);
...
__extern xdc_Int ti_sysbios_family_arm_a9_Timer_Instance_init__E(ti_sysbios_family_arm_a9_Timer_Object *, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_a9_Timer_Params *, xdc_runtime_Error_Block *);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_family_arm_a9_Timer_Instance_finalize__E, "ti_sysbios_family_arm_a9_Timer_Instance_finalize")
__extern void ti_sysbios_family_arm_a9_Timer_Instance_finalize__E( ti_sysbios_family_arm_a9_Timer_Object* , int );
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_family_arm_a9_Timer_Object__destruct__S, "ti_sysbios_family_arm_a9_Timer_Object__destruct__S")
