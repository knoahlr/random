...
#define ti_sysbios_family_arm_a8_intcps_Hwi___VERS 160
...
__extern xdc_Int ti_sysbios_family_arm_a8_intcps_Hwi_Instance_init__E(ti_sysbios_family_arm_a8_intcps_Hwi_Object *, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_a8_intcps_Hwi_Params *, xdc_runtime_Error_Block *);
...
__extern void ti_sysbios_family_arm_a8_intcps_Hwi_Instance_finalize__E( ti_sysbios_family_arm_a8_intcps_Hwi_Object* , int );
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_family_arm_a8_intcps_Hwi_Object__destruct__S, "ti_sysbios_family_arm_a8_intcps_Hwi_Object__destruct__S")
