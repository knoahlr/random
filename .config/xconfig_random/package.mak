...
override PKGDIR = xconfig_random
...
package/%.xdc.inc package/%_xconfig_random.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_random" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: random.pem4f

-include package/cfg/random_pem4f.mak
-include package/cfg/random_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/random_pem4f.dep
endif
random.pem4f: package/cfg/random_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
random.pem4f package/cfg/random_pem4f.c: .libraries,em4f
endif

package/cfg/random_pem4f.c package/cfg/random_pem4f.h package/cfg/random_pem4f.xdl: override _PROG_NAME := random.xem4f
package/cfg/random_pem4f.c: package/cfg/random_pem4f.cfg
package/cfg/random_pem4f.xdc.inc: package/cfg/random_pem4f.xdl
package/cfg/random_pem4f.xdl package/cfg/random_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/random_pem4f.cfg
	-$(RM) package/cfg/random_pem4f.dep
	-$(RM) package/cfg/random_pem4f.c
	-$(RM) package/cfg/random_pem4f.xdc.inc

clean,em4f::
	-$(RM) random.pem4f
.executables,em4f .executables: random.xem4f

random.xem4f: |random.pem4f

-include package/cfg/random.xem4f.mak
random.xem4f: package/cfg/random_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/random_pem4f.oem4f   package/cfg/random_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
random.xem4f: export C_DIR=
random.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
random.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

random.test test,em4f test: random.xem4f.test

random.xem4f.test:: random.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 random.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.random.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,random.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
random_pem4f.oem4f,copy : package/cfg/random_pem4f.oem4f
random_pem4f.sem4f,copy : package/cfg/random_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_random
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_random.tar.dep
endif
package/rel/xconfig_random/xconfig_random/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_random/xconfig_random/package/package.rel.xml: package/build.cfg
package/rel/xconfig_random/xconfig_random/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_random/xconfig_random/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_random.tar: package/rel/xconfig_random.xdc.inc package/rel/xconfig_random/xconfig_random/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_random.xdc.inc,package/rel/xconfig_random.tar.dep)


release release,xconfig_random: all xconfig_random.tar
clean:: .clean
	-$(RM) xconfig_random.tar
	-$(RM) package/rel/xconfig_random.xdc.inc
	-$(RM) package/rel/xconfig_random.tar.dep
